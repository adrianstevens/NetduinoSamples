...
{
    public abstract class DisplayTFTSPIBase : NetworkClock.DisplayBase, IDisposable
    {
        #region Enums
        ...
        //these displays typically supports 12, 16 & 18 bit but the current driver only supports 16
