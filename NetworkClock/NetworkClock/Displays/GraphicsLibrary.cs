...
namespace Netduino.Foundation.Displays
{
    ...
    public class GraphicsLibrary
    {
        ...
        /// <summary>
        /// </summary>
        private readonly NetworkClock.DisplayBase _display;
        ...
        public GraphicsLibrary(NetworkClock.DisplayBase display)
        {
            _display = display;
            CurrentFont = null;
        }
        ...
        public void DrawText(int x, int y, string text, bool wrap = false)
        {
            ...
            DrawBitmap(x, y, bitMap.Length / CurrentFont.Height, CurrentFont.Height, bitMap, NetworkClock.DisplayBase.BitmapMode.And);
        }
        ...
        public void DrawBitmap(int x, int y, int width, int height, byte[] bitmap, NetworkClock.DisplayBase.BitmapMode bitmapMode)
        {
