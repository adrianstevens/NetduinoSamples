...
namespace VC0706_MapleServer
{
    public class RequestHandler : RequestHandlerBase
    {
        ...
        public void getImage ()
        {
            ...
            using (var fs = new FileStream(Program.ImageFileName, FileMode.Open, FileAccess.Read))
            {
            ...
            //    Context.Response.OutputStream.Write(buffer, 0, (int)fs.Length);
            }

            Debug.Print(imageBase64);
