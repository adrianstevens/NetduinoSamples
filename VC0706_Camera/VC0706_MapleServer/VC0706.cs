...
namespace netduino.helpers.Hardware
{
    public class VC0706 : IDisposable
    {
        ...
        public void StartAutoMotionDetection(int imageSequenceNumber, string storagePath, MotionDetectedHandler motionDetectionHandler)
        {
            ...
            _autoMotionThread = new Thread(MotionDetectionThread);
        ...
        {
            showMode = 0;
            currentColor = ColorControl.Automatic;
        ...
        public void GetDownSize(out Zoom width, out Zoom height)
        {
        ...
        public void SetDownSize(Zoom width, Zoom height)
        {
